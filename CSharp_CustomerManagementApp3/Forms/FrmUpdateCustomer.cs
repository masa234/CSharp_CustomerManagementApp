...
namespace CSharp_CustomerManagementApp3.Forms
{
    public partial class FrmUpdateCustomer : Form
    {
        ...
        //更新対象顧客ID
        private readonly long updateCustomerID;

        public FrmUpdateCustomer(long loginUserID, long updateCustomerID)
        {
            InitializeComponent();
        ...
        private void BtnUpdateCustomer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //更新
                customer.UpdateCustomer(customerName,
                                        age,
                                        gender,
                                        companyName,
                                        deptName,
        ...
        private void SetCustomer()
        {
            ...
            //顧客情報を取得
            CustomerData customerData = customer.GetCustomer(this.updateCustomerID);

            //画面に設定
            //顧客氏名
            this.TxtCustomerName.Text = customerData.CustomerName;
            //年齢
            this.TxtAge.Text = customerData.Age.ToString();
            //性別
            this.CmbGender.Text = customerData.Gender;
            //会社名
            this.TxtCompanyName.Text = customerData.CompanyName;
            //部署名
            this.TxtDeptName.Text = customerData.DeptName;
            //メールアドレス
            this.TxtMailAddress.Text = customerData.MailAddress;
            //備考
            this.TxtRemarks.Text = customerData.Remarks;
        }
    }
}
